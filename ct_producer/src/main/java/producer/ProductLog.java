...
public class ProductLog {
    ...
    public String product() {
        ...
        String buildTime = randomBuilTime(startTime, endTime);
        //0000
        DecimalFormat df = new DecimalFormat("0000");
        String duration = df.format((int) (30 * 60 * Math.random()));
        StringBuilder sb = new StringBuilder();
        sb.append(caller + ",").append(callee + ",")
                .append(buildTime + ",").append(duration);
//        System.out.println(caller + "," + callee + ","
//                + calleeName + "," + buildTime + "," + duration);
    ...
    /**
     * 根据传入时间区间，在此范围内随机通话建立时间
     * startTimeTS + (endTimeTs - startTimeTs) * Math.random();
     * @param startTime
     * @param endTime
     * @return
     */
    public String randomBuilTime(String startTime, String endTime) {
        try {
